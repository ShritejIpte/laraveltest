...
<body class="bg-dark">
 <div class="container">
   <div class="row">
     ...
     <h3 class="float-left">  Welcome Admin </h3>
     <h6 class="float-right">  <a href="{{ url('/admin/logout') }}"><i class="far fa-gem"></i><span>Logout</span></a></h6>
     </div>
       <div class="card mt-5">
         <div class="card-header">
            <div class="col-md-12">
                <h4 class="card-title">Product List
                  <a class="btn btn-success ml-5 float-right" href="javascript:void(0)" id="createNewItem"> Create New Item</a>
                </h4>
            </div>
         </div>
         <div class="card-body">
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.editItem', function () {
      ...
      $.get("{{ route('Dashboard.index') }}" +'/' + Item_id +'/edit', function (data) {
...
var formData = new FormData(this);
    ...
    $('body').on('click', '.deleteItem', function () {
        ...
        $.ajax({
            type: "DELETE",
            url: "{{ route('Dashboard.store') }}"+'/'+Item_id,
            success: function (data) {
                table.draw();
            },
            error: function (data) {
